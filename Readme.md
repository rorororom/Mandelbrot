...
### Задание
Исследовать влияние применения SSE (Streaming SIMD Extensions) инструкций на производительность программы алгоритма построения множества Мандельброта. Ожидается, что использование SSE инструкций улучшит эффективность вычислений.
